...
```bash
/Users/shift/openclaw/company-kernel/state/task-intake/incoming
/Users/shift/openclaw/company-kernel/state/task-intake/processed
/Users/shift/openclaw/company-kernel/state/task-intake/failed
```
