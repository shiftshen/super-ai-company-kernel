...
class EconomicsTest(unittest.TestCase):
    ...
    def test_compute_economics_margin(self):
        ...
        try:
            ...
            conn.execute("INSERT OR REPLACE INTO tasks(id,source_agent,target_agent,title,description,priority,status,created_at,updated_at) VALUES('eco-t1','owner-shift','codex','fix bug','修复测试','P2','completed','t','t')")
